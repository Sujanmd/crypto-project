...
function Performance() {
  ...
  return (
    <div style ={{background: "rgba(99, 41, 90, 1)"}}>
    <div>
      ...
      {/* Achievements */}
      <div style={{ marginTop: "34px", background: "#efeaf8", padding: "18px", borderRadius: "10px",color: "rgba(0, 9, 12, 1)", maxWidth: 480 }}>
      ...
      {/* Goals section */}
      <div style={{ marginTop: "30px", background: "#f8f3fa", padding: "16px",color: "rgba(0, 9, 12, 1)", borderRadius: "10px", maxWidth: 480 }}>
